...
const SubjectsList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ value, row }) => (
          <Link
            to={`/admin/academics/subjects/edit/${encodeParam(row.id)}`}
  ...
  return (
    <div className="content">
      ...
      <DataTable
        title="All Subjects"
        subtitle="Manage academic curriculum and subject masters."
        columns={columns}
        data={subjects}
        loading={loading}
        selectable={true}
        ...
        searchPlaceholder="Search by subject, class, or order..."
        emptyMessage="No subjects found in the system."
      />
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body text-center pt-0 pb-4">
                ...
                <h4 className="mb-2">Delete Subject</h4>
                <p className="text-muted mb-4">
                  Are you sure you want to delete{' '}
                  <strong>{subjectToDelete?.subject_name}</strong>? This action cannot be undone.
                </p>
