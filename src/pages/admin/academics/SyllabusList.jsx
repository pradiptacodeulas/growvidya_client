...
const SyllabusList = () => {
  ...
  const fetchSyllabusFromServer = useCallback(
    async ({
    ...
    [isTeacher, selectedAcademicYear, selectedClass, selectedStatus, currentPage, perPage, search]
  );
  ...
  useEffect(() => {
    ...
    const loadFilters = async () => {
      try {
        ...
        if (initialAy) {
          params.academic_year_id = initialAy;
          params.academic_year = initialAy;
        }
        if (initialCls) {
          params.class_id = initialCls;
        }
