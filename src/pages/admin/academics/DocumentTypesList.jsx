...
const DocumentTypesList = () => {
  ...
  const filteredDocs = useMemo(() => {
    let result = documentTypes.filter((d) => {
      const q = search.toLowerCase();
      return (d.document_type_name || '').toLowerCase().includes(q);
    });
    ...
    return result;
  }, [documentTypes, search, sortField, sortAsc]);
  ...
  const handleSelectAll = (e) => {
    if (e.target.checked) {
      setSelectedIds(currentRecords.map((d) => d.id));
    } else {
      setSelectedIds([]);
    }
  };
  ...
  const handleExportExcel = () => {
    ...
    a.href = url;
    a.download = `Document_Types_List_${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
    ...
    <div className="content">
      ...
      <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div className="my-auto mb-2">
          <h3 className="page-title mb-1">Document Type List</h3>
          <nav>
      ...
      <div className="card">
        <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
          <h4 className="mb-3">All Document Type</h4>
        </div>
                          ...
                          <div className="form-check form-check-md d-flex justify-content-center">
                            <input
                              ...
                              checked={
                                ...
                                currentRecords.every((d) => selectedIds.includes(d.id))
                              }
                    ...
                    <tbody>
                      {loading ? (
                        ...
                        currentRecords.map((doc, idx) => {
                          ...
                          const isActive = Number(doc.status) === 1;

                          return (
                            <tr key={doc.id || idx} className={isEven ? 'even' : 'odd'}>
                              ...
                              <td className="text-center">{doc.document_type_name}</td>
                                  ...
                                  <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end p-3">
                                      <li>
                                        <Link
                                          className="dropdown-item rounded-1"
                                          to={`/admin/academics/document-types/edit/${doc.id}`}
                                        >
            ...
            <div className="modal-content">
              ...
              <div className="modal-body text-center py-4">
                ...
                <p className="text-muted mb-0">
                  Do you really want to delete Document Type <strong>{docToDelete?.document_type_name}</strong>? This action cannot be undone.
                </p>
              </div>
