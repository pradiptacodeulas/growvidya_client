...
const StudyMaterialsList = () => {
  ...
  const handleOpenAddModal = () => {
    ...
    setFormData({
      ...
      material_type_id: materialTypes[0]?.id ? String(materialTypes[0].id) : '',
  ...
  const handleOpenEditModal = (material) => {
    ...
    setFormData({
      ...
      academic_year_id: material.academic_year_id ? String(material.academic_year_id) : (currentYear?.id ? String(currentYear.id) : ''),
      material_type_id: material.material_type_id ? String(material.material_type_id) : (materialTypes[0]?.id ? String(materialTypes[0].id) : ''),
