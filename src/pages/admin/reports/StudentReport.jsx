    ...
    <div className="content content-two">
      ...
      <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
        <div className="my-auto mb-2">
          <h3 className="page-title mb-1 text-dark fw-semibold">Student Report</h3>
          <nav>
                    ...
                    >
                      <thead className="thead-light">
                        <tr>
                          ...
                          <th style={{ minWidth: '180px', whiteSpace: 'nowrap' }}>Parent Name</th>
                          ...
                          <th className="text-center" style={{ width: '130px', whiteSpace: 'nowrap' }}>
                            Admission Date
                          </th>
                          <th className="text-center" style={{ width: '120px', whiteSpace: 'nowrap' }}>
                            DOB
                          </th>
                          ...
                          students.map((student, idx) => {
                            ...
                            return (
                              <tr key={`student-report-item-${student.student_id || 'row'}-${idx}`} className={isOdd ? 'odd' : 'even'}>
                                ...
                                <td style={{ whiteSpace: 'nowrap' }}>
                                  <div>
                                    <p className="text-dark fw-medium mb-0">{student.parent_name || '—'}</p>
                                    {student.parent_phone && (
                                      <span className="text-muted fs-12">{student.parent_phone}</span>
                                    )}
                                  </div>
                                </td>
                                <td className="text-center text-dark" style={{ whiteSpace: 'nowrap' }}>
