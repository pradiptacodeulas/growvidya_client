                    ...
                    <tr key={alloc.id}>
                      ...
                      <td>
                        <div className="d-flex align-items-center flex-wrap gap-1">
                          ...
                          {alloc.branch_name && (
                            <span className="badge bg-primary-transparent text-primary fs-11" title={`Campus: ${alloc.branch_name}`}>
                              <i className="ti ti-building me-1"></i>{alloc.branch_name}
                            </span>
                          )}
                        </div>
                        {alloc.roll_number && (
                          <small className="text-muted d-block fs-12">(Roll: {alloc.roll_number})</small>
                        )}
                      </td>
                      <td>
