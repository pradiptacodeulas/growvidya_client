...
const StudentList = () => {
  ...
  const getStudentImageUrl = (student) => {
    ...
    return resolveImageUrl(pic, fallbackImage);
  };
            ...
            <div className="col-xxl-3 col-xl-4 col-md-6 d-flex" key={student.id}>
              ...
              <div className="card flex-fill">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center justify-content-between gx-2 fs-13">
                    ...
                    <div>
                      ...
                      <p className="text-dark fw-medium mb-0">{student.gender || 'N/A'}</p>
                    </div>
                    <div>
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  {student.branch_name ? (
                    <span
                      className="text-muted fs-12 text-truncate me-2 d-inline-flex align-items-center"
                      title={`Campus: ${student.branch_name}`}
                      style={{ maxWidth: '160px' }}
                    >
                      <i className="ti ti-building me-1 text-primary flex-shrink-0"></i>
                      <span className="text-truncate">{student.branch_name}</span>
                    </span>
                  ) : (
                    <span></span>
                  )}
                  <Link
                    ...
                    className="btn btn-outline-success btn-sm fw-semibold flex-shrink-0"
                  >
                    View Details
                  </Link>
                </div>
