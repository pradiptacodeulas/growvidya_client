...
const ViewMarksheetResult = () => {
  ...
  const rawStudentId = studentId || searchParams.get('student_id') || searchParams.get('id') || '';
  ...
  const fetchPdfPreview = async () => {
    if (!effectiveStudentId) {
      setLoading(false);
      setError('Please select a valid student to view their marksheet.');
      return;
    }
    try {
      setLoading(true);
      ...
      {loading ? (
        ...
        <div className="d-flex flex-column align-items-center justify-content-center w-100 h-100 bg-light p-5 text-center">
          ...
          <div className="d-flex align-items-center gap-2">
            <Link to="/admin/records/marksheet" className="btn btn-outline-secondary btn-sm">
