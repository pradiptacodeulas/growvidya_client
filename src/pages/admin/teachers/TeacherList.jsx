              ...
              <div className="card flex-fill shadow-sm border">
                ...
                <div className="card-header d-flex align-items-center justify-content-between">
                  <Link
                    ...
                    title={teacher.teacher_id || (teacher.id ? `T-${teacher.id}` : 'N/A')}
                  >
                    {teacher.teacher_id || (teacher.id ? `T-${teacher.id}` : 'N/A')}
                  </Link>
              ...
              <div className="modal-body">
                ...
                <div className="row g-3">
                  <div className="col-6">
                    ...
                    <p className="fw-semibold mb-0">{selectedTeacher.teacher_id || (selectedTeacher.id ? `T-${selectedTeacher.id}` : 'N/A')}</p>
                  </div>
                  <div className="col-6">
