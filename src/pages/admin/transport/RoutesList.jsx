...
const RoutesList = () => {
  ...
  const handleSelectAll = () => {
    if (selectedRows.length === routes.length) {
      ...
      setSelectedRows(routes.map((r) => r.id));
    }
  };
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: 'transport_route',
        header: 'Transport Route',
        sortable: true,
        cell: ({ value, row }) => (
          <Link
            to={`/admin/transport/route/view/${encodeParam(row.id)}`}
          ...
          <TableActionMenu
            items={[
              ...
              },
              {
                ...
                to: `/admin/transport/route/edit/${encodeParam(row.id)}`,
              },
              {
                label: 'Delete',
                icon: 'ti ti-trash-x',
  ...
  return (
    <div className="content">
      ...
      <DataTable
        ...
        subtitle="Manage bus transit routes, stops, and monthly fares."
        columns={columns}
        data={routes}
        loading={loading}
        selectable={true}
        ...
        searchPlaceholder="Search routes, buses, or numbers..."
        emptyMessage="No transport routes registered."
      />
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body text-center pt-0 pb-4">
                ...
                <h4 className="mb-2">Delete Transport Route</h4>
