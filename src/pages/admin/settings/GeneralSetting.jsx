...
const GeneralSetting = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const friendlyMsg =
        serverMsg &&
        !serverMsg.includes('Illegal mix') &&
        !serverMsg.includes('COALESCE') &&
        !serverMsg.includes('collation')
          ? serverMsg
          : 'Failed to update school configuration. Please verify the entered details.';
