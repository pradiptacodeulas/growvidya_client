...
import { loginStudent, loginStudentWithPasscode, clearStudentAuthError } from '../../store/slices/studentAuthSlice';
import { requestStudentPasscodeApi } from '../../api/studentAuth.api';
...
const StudentLogin = () => {
  ...
  const handleRequestPasscode = async (e) => {
    ...
    if (!identifier.trim()) {
      toast.warning('Please enter your Admission Number, Email, or Phone.');
      return;
    }

    setRequestingPasscode(true);
    try {
      const res = await requestStudentPasscodeApi(identifier.trim());
  ...
  const handleVerifyPasscode = async (e) => {
    ...
    const resultAction = await dispatch(
      loginStudentWithPasscode({ identifier: identifier.trim(), passcode: cleanCode })
    );

    if (loginStudentWithPasscode.fulfilled.match(resultAction)) {
                ...
                <div className="card-body p-4 p-md-5">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-muted fs-13 mb-0">
                      {authMethod === 'passcode'
                        ? step === 1
                          ? 'Enter your Admission No, email, or phone to receive a 6-digit passcode.'
                        ...
                        <form onSubmit={handleVerifyPasscode}>
                          ...
                          <div className="mb-4">
                            ...
                            <div className="d-flex justify-content-between align-items-center mt-2 px-1">
                              ...
                              >
                                <i className="ti ti-pencil me-1"></i>Change Admission No/Phone
                              </button>
                              <button
                                type="button"
