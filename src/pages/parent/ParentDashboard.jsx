                  ...
                  {dashboardData.todayClasses.map((item, idx) => (
                    <div key={idx} className="list-group-item px-0 py-2 d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                          <h6 className="mb-0 fw-bold fs-13 text-dark">{item.subject_name || '-'}</h6>
                          <small className="text-muted fs-11">Teacher: {item.teacher_name || 'Not Assigned'}</small>
                        </div>
                      </div>
                      {item.room_no && (
