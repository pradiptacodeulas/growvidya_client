...
export const requestParentPasscodeApi = async (identifier) => {
  return apiClient.post('/parent/auth/request-passcode', { identifier });
};

export const verifyParentPasscodeApi = async (identifier, passcode) => {
  return apiClient.post('/parent/auth/verify-passcode', { identifier, passcode });
};
